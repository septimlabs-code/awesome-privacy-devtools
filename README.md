...
- **[MetadataRemover.ai](https://metadataremover.ai/)** — Free, open-source metadata toolkit for supported images, PDFs, DOCX, video, and MP3 audio. File processing runs client-side without uploads or accounts. ([Source](https://github.com/songwenlei/metadataremover.ai))
